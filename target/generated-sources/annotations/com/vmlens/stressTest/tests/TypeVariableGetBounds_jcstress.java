...
import com.vmlens.stressTest.tests.TypeVariableGetBounds;
import org.openjdk.jcstress.infra.results.IntResult2_jcstress;

public class TypeVariableGetBounds_jcstress extends Runner<IntResult2_jcstress> {
    ...
    public TypeVariableGetBounds_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "com.vmlens.stressTest.tests.TypeVariableGetBounds");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final TypeVariableGetBounds t = new TypeVariableGetBounds();
        final TypeVariableGetBounds s = new TypeVariableGetBounds();
    ...
    static class Pair {
        public TypeVariableGetBounds s;
